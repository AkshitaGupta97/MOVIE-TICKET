  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      ...
      <div className={`max-md:absolute max-md:top-0 max-md:left-0 max-md:front-medium max-md:text-lg z-50 flex flex-col 
        md:flex-row items-center max-md:justify-center gap-8 md:px-8 py-3 max-md:h-screen md:rounded-4xl backdrop-blur-xl
        ...
        { favouriteMovie.length > 0 &&  <Link onClick={() => {scrollTo(0,0); setIsOpen(false)}} to='/favourite'>Favourite</Link>}
      </div>
      ...
      <div className='flex item-center gap-8'>
        ...
        {
          !user ? (
            <button onClick={openSignIn} className='px-8 py-2 sm:px-4 bg-pink-700 hover:bg-pink-800

...
const checkSeatAvailability = async (showId, selectedSeats) => {
    try {
        ...
        const isAnySeatTaken = selectedSeats.some(seat => Boolean(occupiedSeatsObj[seat])); // Check if any of the selected seats are already occupied
...
export const createBooking = async (req, res) => {
    try {
        ...
        const occupiedSeatsObj = showData.occupiedSeats || {};
        // use .some() so isAnySeatTaken is a boolean
        ...
        selectedSeats.forEach(seat => {
            occupiedSeatsObj[seat] = userId;
        });
        showData.occupiedSeats = occupiedSeatsObj;
